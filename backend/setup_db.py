...
def setup():
    ...
    tables = ["returns","discounts","order_items","orders","inventory",
              "products","categories","suppliers","employees","customers","query_history"]
    for t in tables:
    ...
    CREATE TABLE customers (
        ...
        city          TEXT, state TEXT, gender TEXT, age INTEGER,
        signup_date   TEXT, loyalty_points INTEGER DEFAULT 0
    );
    ...
    CREATE TABLE suppliers (
        ...
        name TEXT, contact_person TEXT, phone TEXT, city TEXT,
        rating REAL
    );
    CREATE TABLE employees (
        employee_id  INTEGER PRIMARY KEY AUTOINCREMENT,
        name TEXT, role TEXT, salary REAL, joining_date TEXT, shift TEXT
    );
    CREATE TABLE products (
        product_id  INTEGER PRIMARY KEY AUTOINCREMENT,
        name TEXT, category_id INTEGER, brand TEXT,
        price REAL, cost_price REAL, unit TEXT
    );
    ...
    CREATE TABLE orders (
        ...
        discount_applied REAL DEFAULT 0, payment_method TEXT
    );
    ...
    CREATE TABLE discounts (
        ...
        product_id       INTEGER, label TEXT,
        discount_percent REAL, start_date TEXT, end_date TEXT
    );
    CREATE TABLE returns (
        return_id     INTEGER PRIMARY KEY AUTOINCREMENT,
        order_id      INTEGER, product_id INTEGER,
        return_date   TEXT, reason TEXT, refund_amount REAL
    );
    CREATE TABLE query_history (
        id           INTEGER PRIMARY KEY AUTOINCREMENT,
        question     TEXT, sql_query TEXT,
        result_count INTEGER DEFAULT 0, created_at TEXT
    );
    """)
    ...
    # Suppliers
    c.executemany("INSERT INTO suppliers (name, contact_person, phone, city, rating) VALUES (?,?,?,?,?)", [
    ...
    # Employees
    c.executemany("INSERT INTO employees (name, role, salary, joining_date, shift) VALUES (?,?,?,?,?)", [
    ...
    # Products
    c.executemany("INSERT INTO products (name, category_id, brand, price, cost_price, unit) VALUES (?,?,?,?,?,?)", [
    ...
    # Inventory
    c.executemany("INSERT INTO inventory (product_id, supplier_id, quantity_in_stock, reorder_level, last_restocked) VALUES (?,?,?,?,?)", [
        (1,1,250,50,'2024-11-01'),(2,1,80,20,'2024-11-01'),(3,8,120,30,'2024-11-02'),
        (4,1,100,25,'2024-11-01'),(5,1,45,20,'2024-10-28'),(6,2,90,25,'2024-10-30'),
        (7,2,150,40,'2024-10-30'),(8,2,300,60,'2024-11-01'),(9,2,35,20,'2024-10-25'),
        (10,7,60,20,'2024-10-29'),(11,2,200,50,'2024-11-01'),(12,5,95,30,'2024-10-28'),
        (13,7,55,20,'2024-10-27'),(14,3,70,25,'2024-10-29'),(15,7,80,25,'2024-10-28'),
        (16,6,180,40,'2024-10-30'),(17,6,160,40,'2024-10-30'),(18,6,90,30,'2024-10-29'),
        (19,10,110,30,'2024-10-31'),(20,6,75,25,'2024-10-29'),(21,4,120,30,'2024-10-30'),
        (22,4,200,50,'2024-10-30'),(23,4,180,45,'2024-10-30'),(24,4,95,30,'2024-10-28'),
        (25,4,140,35,'2024-10-30'),(26,4,220,50,'2024-10-31'),(27,9,60,20,'2024-10-27'),
        (28,1,50,20,'2024-10-26'),(29,7,15,20,'2024-10-20'),(30,8,300,60,'2024-11-01'),
        (31,8,40,20,'2024-10-22'),
    ])

    # Customers
    c.executemany("INSERT INTO customers (name,email,phone,city,state,gender,age,signup_date,loyalty_points) VALUES (?,?,?,?,?,?,?,?,?)", [
    ...
    # Orders
    c.executemany("INSERT INTO orders (customer_id,employee_id,order_date,total_amount,discount_applied,payment_method) VALUES (?,?,?,?,?,?)", [
    ...
    # Order Items
    c.executemany("INSERT INTO order_items (order_id,product_id,quantity,unit_price,subtotal) VALUES (?,?,?,?,?)", [
    ...
    # Discounts
    c.executemany("INSERT INTO discounts (product_id,label,discount_percent,start_date,end_date) VALUES (?,?,?,?,?)", [
    ...
    # Returns
    c.executemany("INSERT INTO returns (order_id,product_id,return_date,reason,refund_amount) VALUES (?,?,?,?,?)", [
    ...
    conn.commit()
    conn.close()
    print("✅ QuickKart SQLite database setup complete!")
